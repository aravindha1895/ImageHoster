...
public class CommentControllerTest {
    ...
    public void createComment() throws Exception {
        ...
        Mockito.when(commentService.getAllComments(image.getId())).thenReturn(commentList);

       this.mockMvc.perform(MockMvcRequestBuilders.post("/image/1/new/comments")
                .param("comment", "This comment is for testing purpose")
                .session(session))
                .andExpect(redirectedUrl("/images/1/new"));
        /*this.mockMvc.perform(MockMvcRequestBuilders.multipart("/image/1/new/comments")
        .param("comment", "This comment is for testing purpose")
        .session(session))
        .andExpect(view().name("/images/1/new"));*/
    }
}
